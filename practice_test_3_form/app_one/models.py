...
class UserManager(models.Manager):
    ...
    def quote_validator(self,postData):
        ...
        if len(postData['quote']) < 4:
            errors["quote"] = "last name should be at least 4 characters"
...
class Quote(models.Model):
    ...
    users = models.ForeignKey(User, related_name="quotes", on_delete=models.CASCADE)
